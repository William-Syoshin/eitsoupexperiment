...
# --- 拡大図（Inset） ---
axins = inset_axes(ax, width="40%", height="35%", loc=4, borderpad=1.0)
...
axins.plot(x_fit, a3 * x_fit + b3, color='#1f77b4', linestyle='-', linewidth=lw_main+1.0, zorder=z_line)
# 💡拡大図の散布図にも linewidths=marker_lw を追加
#axins.scatter(x1, y1, color='black', marker='o', s=marker_s/2, facecolors='none', edgecolors='black', alpha=alpha_m, linewidths=marker_lw)
#axins.scatter(x2, y2, color='#d62728', marker='^', s=marker_s/2, facecolors='none', edgecolors='#d62728', alpha=alpha_m, linewidths=marker_lw)
#axins.scatter(x3, y3, color='#1f77b4', marker='s', s=marker_s/2, facecolors='none', edgecolors='#1f77b4', alpha=alpha_m, linewidths=marker_lw)
